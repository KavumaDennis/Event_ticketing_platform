...
class OrganizersController extends Controller
{
  ...
  public function show($id)
  {
    ...
    // Fetch suggested organizers (random 5, excluding current)
    $suggestedOrganizers = Organizer::where('id', '!=', $id)
            ->withCount('followers') // efficient count
            ->inRandomOrder()
            ->take(7)
            ->get();
    ...
    return view('organizerDetails', [
        'organizer' => $organizer,
        'suggestedOrganizers' => $suggestedOrganizers
    ]);
  }

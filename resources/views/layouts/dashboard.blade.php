...
<body x-data="{ sidebarOpen: false }" class="bg-black/85 bg-[url(/public/bg-img.png)] bg-cover bg-center bg-fixed bg-blend-multiply">
    ...
    {{-- Mobile Sidebar --}}
    <div x-show="sidebarOpen" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="-translate-x-full" x-transition:enter-end="translate-x-0" x-transition:leave="transition ease-in duration-200" x-transition:leave-start="translate-x-0" x-transition:leave-end="-translate-x-full" class="fixed inset-y-0 left-0 w-64 bg-black/85 bg-[url(/public/bg-img.png)] bg-cover bg-center bg-fixed  bg-blend-multiply backdrop-blur-[1px] border-r border-white/10 z-50 lg:hidden p-6 overflow-y-auto" x-cloak>
        ...
        <div class="space-y-4">
            <a href="{{ route('user.dashboard.overview') }}" class="flex items-center gap-3 p-3 font-medium text-sm rounded-xl {{ request()->routeIs('user.dashboard.overview') ? 'bg-orange-500 text-black font-bold' : 'text-zinc-400' }}">
            ...
            <a href="{{ route('user.dashboard.trends') }}" class="flex items-center gap-3 p-3 font-medium text-sm rounded-xl {{ request()->routeIs('user.dashboard.trends') ? 'bg-orange-500 text-black font-bold' : 'text-zinc-400' }}">
            ...
            <a href="{{ route('user.dashboard.events') }}" class="flex items-center gap-3 p-3 font-medium text-sm rounded-xl {{ request()->routeIs('user.dashboard.events') ? 'bg-orange-500 text-black font-bold' : 'text-zinc-400' }}">
            ...
            <a href="{{ route('user.dashboard.calendar') }}" class="flex items-center gap-3 p-3 font-medium text-sm rounded-xl {{ request()->routeIs('user.dashboard.calendar') ? 'bg-orange-500 text-black font-bold' : 'text-zinc-400' }}">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    <rect width="18" height="18" x="3" y="4" rx="2" ry="2" />
                    <line x1="16" x2="16" y1="2" y2="6" />
                    <line x1="8" x2="8" y1="2" y2="6" />
                    <line x1="3" x2="21" y1="10" y2="10" />
                    <line x1="12" x2="12.01" y1="15" y2="15" /></svg>
                My Calendar
            </a>
            <hr class="border-white/10 my-4">
            <a href="{{ route('user.dashboard.tickets') }}" class="flex items-center gap-3 p-3 font-medium text-sm rounded-xl {{ request()->routeIs('user.dashboard.tickets') ? 'bg-orange-500 text-black font-bold' : 'text-zinc-400' }}">
            ...
            <a href="{{ route('user.dashboard.orders') }}" class="flex items-center gap-3 p-3 font-medium text-sm rounded-xl {{ request()->routeIs('user.dashboard.orders') ? 'bg-orange-500 text-black font-bold' : 'text-zinc-400' }}">
            ...
            <a href="{{ route('user.dashboard.messages') }}" class="flex items-center gap-3 p-3 font-medium text-sm rounded-xl {{ request()->routeIs('user.dashboard.messages') ? 'bg-orange-500 text-black font-bold' : 'text-zinc-400' }}">
            ...
            <a href="{{ route('user.dashboard.security') }}" class="flex items-center gap-3 p-3 font-medium text-sm rounded-xl {{ request()->routeIs('user.dashboard.security') ? 'bg-orange-500 text-black font-bold' : 'text-zinc-400' }}">
            ...
            <a href="{{ route('user.dashboard.support') }}" class="flex items-center gap-3 p-3 font-medium text-sm rounded-xl {{ request()->routeIs('user.dashboard.support') ? 'bg-orange-500 text-black font-bold' : 'text-zinc-400' }}">
    ...
    <div class="h-screen flex flex-col lg:grid lg:grid-cols-12 gap-3 p-3 overflow-hidden">
        ...
        <div class="lg:hidden flex justify-between items-center p-4 bg-green-400/10 rounded-2xl mb-2">
            ...
            <a href="{{ route('user.profile', auth()->id()) }}" class="w-8 h-8 rounded-full bg-orange-400 flex items-center justify-center text-black font-bold text-xs hover:bg-orange-400 transition-colors">
        ...
        <nav class="col-span-2 bg-green-400/10 rounded-2xl p-4 h-fit hidden lg:block overflow-y-auto text-white/80">
            ...
            <div class="space-y-1">
                ...
                <a href="{{ route('user.dashboard.calendar') }}" class="flex items-center gap-2 py-3 px-4 rounded-xl font-medium text-sm {{ request()->routeIs('user.dashboard.calendar') ? 'bg-green-400/10 border border-green-400/5 text-orange-400/90' : 'text-zinc-400' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <rect width="18" height="18" x="3" y="4" rx="2" ry="2" />
                        <line x1="16" x2="16" y1="2" y2="6" />
                        <line x1="8" x2="8" y1="2" y2="6" />
                        <line x1="3" x2="21" y1="10" y2="10" />
                        <line x1="12" x2="12.01" y1="15" y2="15" /></svg>
                    <span class='font-medium flex items-center pl-2.5 relative after:content-[""] after:bg-zinc-400 after:absolute after:w-[3px] after:h-[10px] after:rounded-lg after:left-0'>My Calendar</span>
                </a>
            ...
            <a href="{{ route('user.dashboard.messages') }}" class="flex items-center gap-2 py-3 px-4 rounded-xl font-medium text-sm {{ request()->routeIs('user.dashboard.messages') ? 'bg-green-400/10 border border-green-400/5 text-orange-400/90' : 'text-zinc-400' }}">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-message-square">
                    <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /></svg>
                <span class='font-medium flex items-center pl-2.5 relative after:content-[""] after:bg-zinc-400 after:absolute after:w-[3px] after:h-[10px] after:rounded-lg after:left-0'>Messages</span>
            </a>
        ...
        <div class="col-span-12 lg:col-span-10 flex flex-col overflow-hidden">
            ...
            <div class="p-2 bg-green-400/10 rounded-2xl w-full mb-5 flex items-center justify-end gap-3 shrink-0">
                <a href="{{ route('events.create') }}" class="flex items-center gap-2 p-0.5 bg-orange-400 border border-green-400/10 rounded-3xl">
                ...
                <a href="{{ route('user.dashboard.saved') }}" class="relative flex items-center justify-center bg-orange-400 border border-green-400/10 size-9 text-black/90 rounded-full hover:bg-orange-400 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-bookmark">
                        <path d="m19 21-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z" />
                    </svg>
                    @if(auth()->user()->savedEvents()->count() > 0)
                    <span id="saved-count-badge" class="absolute -top-1 -right-1 size-4 bg-red-500 text-white text-[8px] font-bold flex items-center justify-center rounded-full border border-black">
                        {{ auth()->user()->savedEvents()->count() }}
                    </span>
                    @else
                    <span id="saved-count-badge" class="hidden absolute -top-1 -right-1 size-4 bg-red-500 text-white text-[8px] font-bold items-center justify-center rounded-full border border-black">
                        0
                    </span>
                    @endif
                </a>

                <a href="{{ route('user.dashboard.notifications') }}" class="relative flex items-center justify-center bg-orange-400 border border-green-400/10 size-9 text-black/90 rounded-full hover:bg-orange-400 transition-colors">
                    ...
                    <span class="absolute -top-1 -right-1 size-4 bg-red-500 text-white text-[8px] font-bold flex items-center justify-center rounded-full border border-black">
                        {{ auth()->user()->unreadNotificationsCount() }}
                    </span>
                    @endif
                </a>

                <a href="{{ route('home') }}" class="flex items-center justify-center bg-orange-400 border border-green-400/10 size-9 text-black/90 rounded-full">
                ...
                <form action="{{ route('logout') }}" method="POST">
                    @csrf
                    <button class="flex items-center p-0.5 w-fit bg-orange-400 gap-1 rounded-3xl">

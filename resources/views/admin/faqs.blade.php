    ...
    <div class="bg-black/85 bg-[url(/public/bg-img.png)] bg-cover bg-center bg-fixed  bg-blend-multiply border border-green-400/30 backdrop-blur-[1px] w-full max-w-lg p-4 shadow-xl relative">
        ...
        <form action="{{ route('admin.faqs.store') }}" method="POST">
            ...
            <div class="space-y-4">
                ...
                <button type="submit" class="px-4 py-2 bg-orange-400 rounded-3xl mt-3 text-sm font-mono">Save FAQ</button>
            </div>
        </form>
    </div>
</div>
    ...
    <div class="bg-black/85 bg-[url(/public/bg-img.png)] bg-cover bg-center bg-fixed  bg-blend-multiply border border-green-400/30 backdrop-blur-[1px] w-full max-w-lg p-4 shadow-xl relative">
        ...
        <form id="editFaqForm" method="POST">
            ...
            <div class="space-y-4">
                ...
                <button type="submit" class="w-fit bg-orange-400 px-4 py-2 rounded-3xl mt-3 text-sm font-mono">Update FAQ</button>
            </div>
        </form>
    </div>
</div>

...
<div class="max-w-4xl mx-auto">
    <div class="bg-green-400/10 rounded-3xl overflow-hidden border border-white/5 shadow-2xl">
        ...
        <form action="{{ route('admin.organizers.update', $organizer->id) }}" method="POST" class="p-8 space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="business_name" value="{{ $organizer->business_name }}" class="w-full bg-black/50 border border-zinc-800 rounded-2xl px-5 py-3 text-white focus:outline-none focus:border-orange-500 transition-colors">
                    </div>

                    <div>
                        <label class="block text-zinc-500 text-[10px] uppercase font-bold mb-2 ml-1">Business Email</label>
                        <input type="email" name="business_email" value="{{ $organizer->business_email }}" class="w-full bg-black/50 border border-zinc-800 rounded-2xl px-5 py-3 text-white focus:outline-none focus:border-orange-500 transition-colors">
                    </div>

                    <div>
                        <label class="block text-zinc-500 text-[10px] uppercase font-bold mb-2 ml-1">Contact Number</label>
                        <input type="text" name="contact_number" value="{{ $organizer->contact_number }}" class="w-full bg-black/50 border border-zinc-800 rounded-2xl px-5 py-3 text-white focus:outline-none focus:border-orange-500 transition-colors">
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="tier" class="w-full bg-black/50 border border-zinc-800 rounded-2xl px-5 py-3 text-white focus:outline-none focus:border-orange-500 transition-colors">
                    ...
                    <div>
                        ...
                        <select name="payout_frequency" class="w-full bg-black/50 border border-zinc-800 rounded-2xl px-5 py-3 text-white focus:outline-none focus:border-orange-500 transition-colors">
            ...
            <div class="pt-8 border-t border-zinc-800 flex justify-between items-center">
                ...
                <div class="flex gap-4">
                    <a href="{{ route('admin.organizers') }}" class="px-6 py-3 text-zinc-500 hover:text-white transition-colors text-sm font-bold uppercase tracking-widest">Discard</a>
                    <button type="submit" class="px-10 py-3 bg-orange-500 text-black font-bold rounded-2xl hover:bg-orange-400 transition-all shadow-lg shadow-orange-500/20 active:scale-95">Push Changes</button>
                </div>
            </div>
        </form>
    </div>

    ...
    <div class="w-full max-w-md bg-green-400/10 border border-green-400/10 p-8 rounded-2xl shadow-2xl backdrop-blur-xl">
        ...
        <form action="{{ route('password.update') }}" method="POST" class="flex flex-col gap-6">
            ...
            <div class="flex flex-col gap-2">
                ...
                <input type="password" name="password" autocomplete="new-password" placeholder="Min 8 characters" required class="p-3 rounded-xl bg-[#b0a6df]/10 outline outline-[#b0a6df]/20 text-orange-400/70 text-sm font-semibold placeholder-orange-400/70" />
            </div>

            <div class="flex flex-col gap-2">
                <label class="text-white/60 font-medium ml-1 text-sm">Confirm Password</label>
                <input type="password" name="password_confirmation" autocomplete="new-password" placeholder="Repeat password" required class="p-3 rounded-xl bg-[#b0a6df]/10 outline outline-[#b0a6df]/20 text-orange-400/70 text-sm font-semibold placeholder-orange-400/70" />
            </div>

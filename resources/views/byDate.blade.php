<x-layout>
    <div class="p-5">
        <h1 class=" flex gap-1 items-center rounded-3xl mb-5 p-0.5 bg-orange-400/70 w-fit">
            <span class="size-9 flex items-center justify-center rounded-[50%] bg-black/90 border border-green-400/10 text-orange-400/80">
        ...
        @if($events->isEmpty())
        <p class="text-white/60 font-mono font-light">No events found for this time period.</p>
        @else

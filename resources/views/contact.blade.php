<x-layout>
    ...
    <div class="flex flex-col items-center">
        <div class="flex flex-col items-center gap-5">
            ...
            <p class='text-5xl text-orange-400/60'>
            ...
            <h1 class='text-5xl tracking-wide text-center  leading-15 text-white/80'>Get in Touch</h1>
            ...
            <div class="flex gap-20  bg-orange-400 w-fit p-1 rounded-4xl">
        ...
        <div class="flex flex-col items-center gap-5 mt-5">
            <p class='text-white/60 font-medium'>Social media</p>
            <div class="flex items-end gap-5 h-full">
                <div class="flex justify-between items-center gap-4 bg-orange-400 border border-green-400/10 p-1 rounded-3xl">
        ...
        <div class="w-[45%] mt-10 mx-auto">
            <form action="{{ route('contact.submit') }}" method="POST" class="flex flex-col gap-5 w-full p-5 rounded-2xl border border-green-400/10 bg-green-400/10">
                ...
                <button type="submit" class='w-full col-span-2 p-3 rounded-4xl text-sm font-mono font-medium bg-black/90 text-white/60 border border-green-400/10'>
                    Contact us
                </button>
            </form>
        </div>

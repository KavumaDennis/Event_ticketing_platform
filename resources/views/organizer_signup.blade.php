        ...
        <div class="h-full w-full px-10 flex items-center bg-green-400/10 border border-green-400/10">
            ...
            <form action="{{ route('organizer_store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col gap-5 w-full" x-data="{ imagePreview: null }">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <input type="text" id="business_name" name="business_name" placeholder="Enter business name" value="{{ old('business_name') }}" class="p-3 rounded-xl bg-white/5 outline outline-white/20 backdrop-blur-4xl text-orange-400/70 text-sm font-semibold placeholder-orange-400/70">
                    @error('business_name')
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <input type="email" id="business_email" name="business_email" placeholder="Enter business email" value="{{ old('business_email') }}" class="p-3 rounded-xl bg-white/5 outline outline-white/20 backdrop-blur-4xl text-orange-400/70 text-sm font-semibold placeholder-orange-400/70">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <input type="text" id="business_website" name="business_website" placeholder="e.g., www.organizer.com" value="{{ old('business_website') }}" class="p-3 rounded-xl bg-white/5 outline outline-white/20 backdrop-blur-4xl text-orange-400/70 text-sm font-semibold placeholder-orange-400/70">

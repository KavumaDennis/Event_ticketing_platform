    ...
    <div class="grid grid-cols-12 gap-8">
        ...
        <div class="col-span-12 lg:col-span-5 space-y-6">
            <div class="bg-green-400/10 rounded-3xl p-8">
                ...
                <div class="space-y-4">
                    <div class="flex items-center gap-4 p-4 bg-orange-400 rounded-2xl border border-zinc-800">
            ...
            <div class="bg-orange-400 p-8 rounded-3xl text-black">
                <i class="fas fa-question-circle text-4xl mb-4"></i>
                <h3 class="text-2xl font-black uppercase tracking-tighter">Security settings</h3>
                ...
                <a href="{{ route('user.dashboard.security') }}" class="inline-block py-3 px-6 bg-black text-white rounded-xl text-xs font-bold uppercase tracking-widest hover:bg-zinc-800 transition-all">Settings</a>
            </div>
        </div>
    </div>
</div>

    ...
    <div class="bg-green-400/10 p-6 rounded-3xl border border-green-400/10">
        ...
        <form action="{{ route('organizer_store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex items-center gap-6 mb-8">
                <img src="{{ $organizer->organizer_image ? asset('storage/'.$organizer->organizer_image) : asset('default.png') }}" class="w-24 h-24 rounded-full object-cover border-2 border-orange-400/50">
                <div>

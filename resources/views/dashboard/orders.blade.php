...
<div class="md:pl-6 md:pb-20">
    ...
    <div class="space-y-4">
        ...
        <div class="bg-green-400/10 border border-green-400/10 p-3 hover:border-orange-400/30 transition-all group">
            <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                ...
                <div class="flex items-center gap-4 lg:gap-8 h-full">
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="{{ route('user.dashboard.tickets') }}" class="px-3 py-1.5 rounded-lg flex items-center gap-2 bg-orange-400 text-black border border-orange-400 hover:bg-orange-500 transition-all text-[10px] font-bold uppercase">
                            View Tickets
                        </a>

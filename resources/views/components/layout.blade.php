            ...
            <div class="grid grid-cols-3 gap-3">
                ...
                <div class="border-t border-white/10 col-span-3 mt-2 pt-3 flex flex-col gap-2">
                    <div class="flex gap-4">
                        <a href="{{ route('show.signup') }}" class="flex-1 text-center p-2 text-black border border-green-400/20 font-medium font-mono bg-orange-400 rounded-3xl">Sign Up</a>
                ...
                <div class="col-span-5 md:col-span-3 grid grid-cols-4 md:flex justify-between gap-10">
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="flex flex-col gap-1 ml-2">
                            ...
                            <div class="mt-5 flex justify-between items-center gap-3 bg-orange-400 border border-green-400/10 p-0.5 rounded-3xl">

...
<body class="bg-black/80 bg-[url('/public/bg-img.png')] bg-cover bg-center bg-fixed bg-blend-multiply relative">
    ...
    <section class="grid grid-cols-6 gap-10 p-5 px-20 h-screen">
        <!-- LEFT SECTION -->
        <div class="col-span-4 h-full p-5 rounded-3xl overflow-hidden overflow-y-scroll  border border-green-400/20 bg-green-400/10">
            <div class="">
                @if (session('success'))
                ...
                <form x-data="{ imagePreview: null }" action="{{ route('events.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col mx-auto  gap-6 w-[90%] p-4">
                    @csrf
        ...
        <div class="col-span-2 flex flex-col justify-between p-2 bg-green-400/10 rounded-4xl">
            <div class="p-1 rounded-3xl border border-green-400/10 bg-green-400/10 flex justify-between items-center">
                ...
                <div class="flex gap-3 items-center">
                    <a href="">
                        <p class="border border-green-400/10 bg-green-400/10 font-mono p-2 px-3 rounded-[20px] text-white/70 text-sm font-medium">
                            Home
                        </p>
                    </a>
                    <a href="">
            ...
            <div class="flex flex-col gap-4 p-2 rounded-3xl border border-green-400/10">
                <div class="flex flex-col p-2">
                    ...
                    <p class="text-white/60 text-sm font-mono font-light">

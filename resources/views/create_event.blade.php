...
<body class="bg-black/80 bg-[url('/public/bg-img.png')] bg-cover bg-center bg-fixed bg-blend-multiply relative">
    ...
    <section class="grid grid-cols-6 gap-5 p-2 h-screen">
        <!-- LEFT SECTION -->
        <div class="col-span-4 h-full overflow-y-auto p-5 rounded-3xl border border-green-400/10 bg-green-400/10">
            <div class="w-full h-full overflow-y-auto ">
                ...
                <form x-data="{ imagePreview: null }" action="{{ route('events.store') }}" method="POST" enctype="multipart/form-data" class="flex flex-col overflow-hidden mx-auto  gap-6 w-[90%] p-4">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input id="event_name" name="event_name" type="text" value="{{ old('event_name') }}" placeholder="Enter event name" class="p-3 rounded-3xl bg-[#b0a6df]/10 outline outline-[#b0a6df]/20 backdrop-blur-4xl text-orange-400/70 text-sm font-semibold placeholder-orange-400/70">
                        @error('event_name')
                        <p class="text-red-400 text-xs ml-1 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input id="category" name="category" type="text" value="{{ old('category') }}" placeholder="e.g. Music, Sports, Workshop" class="p-3 rounded-3xl bg-[#b0a6df]/10 outline outline-[#b0a6df]/20 backdrop-blur-4xl text-orange-400/70 text-sm font-semibold placeholder-orange-400/70">
                        @error('category')
                        <p class="text-red-400 text-xs ml-1 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input id="organizer" name="organizer" type="text" value="{{ $organizerName }}" readonly class="p-3 rounded-3xl bg-[#b0a6df]/10 outline outline-[#b0a6df]/20 backdrop-blur-4xl text-orange-400/70 text-sm font-semibold placeholder-orange-400/70 cursor-not-allowed">
                        ...
                        <input id="organizer" name="organizer" type="text" placeholder="Enter event organizer name" value="{{ old('organizer') }}" class="p-3 rounded-3xl bg-[#b0a6df]/10 outline outline-[#b0a6df]/20 backdrop-blur-4xl text-orange-400/70 text-sm font-semibold placeholder-orange-400/70">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input id="location" name="location" type="text" value="{{ old('location') }}" placeholder="Enter event location" class="p-3 rounded-3xl bg-[#b0a6df]/10 outline outline-[#b0a6df]/20 backdrop-blur-4xl text-orange-400/70 text-sm font-semibold placeholder-orange-400/70">
                        @error('location')
                        <p class="text-red-400 text-xs ml-1 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input id="venue" name="venue" type="text" value="{{ old('venue') }}" placeholder="Enter event venue" class="p-3 rounded-3xl bg-[#b0a6df]/10 outline outline-[#b0a6df]/20 backdrop-blur-4xl text-orange-400/70 text-sm font-semibold placeholder-orange-400/70">
                        @error('venue')
                        <p class="text-red-400 text-xs ml-1 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <input id="event_date" name="event_date" type="date" value="{{ old('event_date') }}" class="p-3 rounded-3xl bg-[#b0a6df]/10 outline outline-[#b0a6df]/20 backdrop-blur-4xl text-orange-400/70 text-sm font-semibold placeholder-orange-400/70">
                        @error('event_date')
                        <p class="text-red-400 text-xs ml-1 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div class="flex flex-col gap-2">
                            ...
                            <input id="start_time" name="start_time" type="time" value="{{ old('start_time') }}" class="p-3 rounded-l-3xl bg-[#b0a6df]/10 outline outline-[#b0a6df]/20 backdrop-blur-4xl text-orange-400/70 text-sm font-semibold placeholder-orange-400/70">
                            @error('start_time')
                            <p class="text-red-400 text-xs ml-1 mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="flex flex-col gap-2">
                            ...
                            <input id="end_time" name="end_time" type="time" value="{{ old('end_time') }}" class="p-3 rounded-r-3xl bg-[#b0a6df]/10 outline outline-[#b0a6df]/20 backdrop-blur-4xl text-orange-400/70 text-sm font-semibold placeholder-orange-400/70">
                            @error('end_time')
                            <p class="text-red-400 text-xs ml-1 mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="">
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <div class="flex flex-col gap-2">
                                    ...
                                    <input type="number" id="{{ $type }}_price" name="{{ $type }}_price" step="0.01" value="{{ old($type.'_price') }}" placeholder="e.g. {{ $type == 'regular' ? '2000' : ($type == 'vip' ? '5000' : '10000') }}" class="p-3 rounded-l-3xl bg-[#b0a6df]/10 outline outline-[#b0a6df]/20 backdrop-blur-4xl text-orange-400/70 text-sm font-semibold placeholder-orange-400/70">
                                    @error($type.'_price')
                                    <p class="text-red-400 text-xs ml-1 mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="flex flex-col gap-2">
                                    ...
                                    <input type="number" id="{{ $type }}_quantity" name="{{ $type }}_quantity" value="{{ old($type.'_quantity') }}" placeholder="e.g. {{ $type == 'regular' ? '100' : ($type == 'vip' ? '50' : '20') }}" class="p-3 rounded-r-3xl bg-[#b0a6df]/10 outline outline-[#b0a6df]/20 backdrop-blur-4xl text-orange-400/70 text-sm font-semibold placeholder-orange-400/70">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <textarea id="description" name="description" placeholder="Describe your event..." class="p-3 w-full h-40 rounded-3xl bg-[#b0a6df]/10 outline outline-[#b0a6df]/20 backdrop-blur-4xl text-orange-400/70 text-sm font-semibold placeholder-orange-400/70">{{ old('description') }}</textarea>
                        @error('description')
                        <p class="text-red-400 text-xs ml-1 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="flex items-center gap-5 p-2 border border-green-400/10 bg-green-400/10 rounded-2xl">
                            <div class="border border-green-400/10  w-fit rounded-[50%]">
                                <img src="{{ $topOrganizer->organizer_image ? asset('storage/'.$topOrganizer->organizer_image) : asset('default.jpg') }}" alt="{{ $topOrganizer->business_name }}" class='size-12 rounded-[50%]' alt="" />
                            </div>

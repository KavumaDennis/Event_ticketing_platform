        ...
        <div class="grid grid-cols-2 gap-10">
            ...
            <div class="flex flex-col gap-5 col-span-2 lg:col-span-1">
                ...
                <a href="{{ route('organizer.create') }}">
                    <div class="p-0.5 flex gap-1 items-center bg-orange-400 text-black/60 font-medium text-sm w-fit rounded-4xl">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div class="flex flex-col gap-3 justify-between p-2 rounded-3xl bg-green-400/10">
                        <div class="p-1 px-2 rounded-2xl border border-green-400/10 bg-green-400/10 font-medium text-orange-400/80 text-xs w-fit">lorem</div>
                    ...
                    <div class="flex flex-col justify-around p-2 rounded-3xl bg-green-400/10 gap-10">
                        <div class="p-2 flex items-center justify-center border border-green-400/10 bg-green-400/10 text-orange-400/80 font-medium text-sm rounded-4xl">
                            The number dont lie
                        </div>
            ...
            <div class="w-full h-full flex flex-col gap-5 justify-between col-span-2 lg:col-span-1">
                ...
                <div class="flex flex-col justify-between gap-3">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-5">
                        <p class="text-xs p-1 font-mono font-medium bg-orange-400 rounded-2xl w-fit text-black/90">Trending categories</p>
    ...
    <div class="p-5">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 mt-5">
            <div class="p-5 col-span-1 flex flex-col gap-3 rounded-3xl bg-green-400/10">
                <span>
                    <p class='size-10 flex items-center justify-center rounded-[50%] text-black/90 bg-orange-400 border border-green-400/10 text-md'>
            ...
            <div class="p-5 col-span-1 flex flex-col gap-3 rounded-3xl bg-green-400/10">
                ...
                <div class="text-white/50 font-mono text-sm font-medium ">
                    Simple and fair pricing helps your event budget go further. There are no contracts or tiers. Just the same great service and support for everyone. Save up to 63% on your ticketing vs our lead competitor*.
                </div>
            </div>
            <div class="p-5 col-span-1 flex flex-col gap-3 rounded-3xl bg-green-400/10">
                <span>
